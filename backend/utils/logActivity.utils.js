...
export const logActivity = async (
    ...
    try {
        ...
        props.ip_address = typeof props.ip_address === 'string' ? props.ip_address : '';
        props.device = typeof props.device === 'string' ? props.device : '';
        props.browser = typeof props.browser === 'string' ? props.browser : '';
        props.platform = typeof props.platform === 'string' ? props.platform : '';
